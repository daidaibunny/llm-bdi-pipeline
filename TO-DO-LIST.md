...
| N15 | Expand the method draft into a full evaluation-ready paper skeleton. | G1, G6, G9 | Add related work, experiment table shells, ablation protocol, final claim checklist, and result-import macros without changing the fixed core algorithm. | Open. Do this after the next implementation/evaluation milestone so the paper text reflects stable results. |
