...
| Manuscript prose and captions | Submission-quality audit complete; page-budget editing deferred | Figures 1--2 now use concise input--output captions; formal symbols and certification details remain in the method and Technical Supplement. The paper separates seed-0 controller ablation from the selected method's five-seed robustness result and retains the admitted-fragment and incomplete-strategy boundaries. |
