...
| Temporal experiment harness | Complete, frozen, and inserted | The four variants consume the same seed-0 Full GP2PL libraries and the same benchmark, bindings, and DFAs. Unprotected, Flat, Balanced, and Module-Return obtain 1,113, 1,228, 1,228, and 1,212 valid traces of 1,228; corrected transition-repair fan-out is 3, 3, 2, and 2. |
