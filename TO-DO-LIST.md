...
| P5 | Layer B evidence tightening | Turns current heuristic-looking modules into defensible learned modules. | Every selected atomic module has a compact proof object: source evidence, covered transitions, rejected alternatives, and selector reason. | Next. |
