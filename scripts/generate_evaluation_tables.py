...
def render_profile_table(result: dict[str, Any]) -> str:
	...
	lines = [
		...
		"\\caption{Temporal-profile results. Eq. is exact DFA-language equivalence; "
		"E2E requires the controller, Jason, VAL, and both DFA checks. Act. and s "
		"are median primitive actions and seconds.}",
