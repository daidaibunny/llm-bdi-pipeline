...
- Main Figure 1 uses a 13.333 by 5.000 inch PowerPoint export canvas.
  ...
  Main Figure 2 is generated by Matplotlib at exactly 7.0 by 3.0 inches. Keep a
...
Use a full-width `figure*[t]` in the main Evaluation section after the protocol
...
time axis. Both panels are 3.0 inches high inside one 7.0-inch `figure*`.
...
- Use Matplotlib's bundled DejaVu Sans font, embedded as TrueType in the PDF.
  ...
  colorblind-safe palette and redundant marker encodings as the conceptual
  figure. Stars are not used: in empirical figures they commonly
...
The main Evaluation source contains the empirical `figure*[t]` placement before
