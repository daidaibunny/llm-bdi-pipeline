...
- **Gold TEG evaluation:** the correct hidden structured LTLf formula is used to
  test the temporal compiler independently of language-model translation.
- **Predicted TEG evaluation:** the language model translates controlled
  natural language into lifted LTLf JSON, and exact gold/predicted DFA-language
  equivalence tests translation quality before execution.
...
3. report gold and predicted TEG results separately;
