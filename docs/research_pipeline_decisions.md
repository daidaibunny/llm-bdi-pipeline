...
sets, incomplete pairing, and infrastructure failures. LaTeX cells and the
compact release JSON are generated from those checked artifacts; aggregate
values are never typed into the manuscript by hand.
