...
\asl{} realization, static sort-membership beliefs may constrain PDDL type
compatibility, but no domain-specific typing predicate becomes an achievement
goal or primitive action. Formal definitions and supported-fragment assumptions
appear in the Technical Supplement, Sec.~1.
