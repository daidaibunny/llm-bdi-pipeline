(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot21 cocktail38)
      (contains shot22 cocktail19)
      (contains shot23 cocktail1)
      (contains shot24 cocktail40)
