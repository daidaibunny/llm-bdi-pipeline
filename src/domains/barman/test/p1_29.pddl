(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot51 cocktail35)
      (contains shot52 cocktail33)
      (contains shot53 cocktail1)
      (contains shot54 cocktail31)
