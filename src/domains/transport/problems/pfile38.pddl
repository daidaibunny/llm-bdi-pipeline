(define (problem pfile38)
 ...
 (:init
  ...
  (road city-loc-67 city-loc-55)
  (road city-loc-67 city-loc-58)
  (road city-loc-67 city-loc-60)
  (road city-loc-68 city-loc-49)
  (road city-loc-68 city-loc-17)
  (road city-loc-68 city-loc-34)
  (road city-loc-68 city-loc-13)
  (road city-loc-69 city-loc-4)
  (road city-loc-69 city-loc-57)
  (at package-0 city-loc-55)
  ...
  (at package-33 city-loc-69)
  (at package-34 city-loc-35)
  (at package-35 city-loc-59)
  (at package-36 city-loc-7)
  (at package-37 city-loc-48)
  (at package-38 city-loc-32)
  (at package-39 city-loc-57)
  (at package-40 city-loc-41)
  (at package-41 city-loc-38)
  (at package-42 city-loc-2)
  (at package-43 city-loc-2)
  (at package-44 city-loc-16)
  (at package-45 city-loc-51)
  (at package-46 city-loc-27)
  (at package-47 city-loc-55)
  (at package-48 city-loc-48)
  (at package-49 city-loc-1)
  (at package-50 city-loc-36)
  (at package-51 city-loc-32)
  (at package-52 city-loc-42)
  (at package-53 city-loc-19)
  (at package-54 city-loc-26)
  (at package-55 city-loc-14)
  (at package-56 city-loc-32)
  (at package-57 city-loc-22)
  (at package-58 city-loc-57)
  (at package-59 city-loc-38)
  (at package-60 city-loc-12)
  (at package-61 city-loc-55)
  (at package-62 city-loc-66)
  (at package-63 city-loc-10)
  (at package-64 city-loc-34)
  (at package-65 city-loc-8)
  (at package-66 city-loc-26)
  (at package-67 city-loc-30)
  (at package-68 city-loc-0)
  (at package-69 city-loc-16)
  (at package-70 city-loc-17)
  (at package-71 city-loc-26)
  (at package-72 city-loc-7)
  (at package-73 city-loc-60)
  (at package-74 city-loc-54)
  (at package-75 city-loc-31)
  (at package-76 city-loc-29)
  (at package-77 city-loc-23)
  (at package-78 city-loc-15)
  (at package-79 city-loc-2)
  (at package-80 city-loc-61)
  (at package-81 city-loc-67)
  (at package-82 city-loc-30)
  (at package-83 city-loc-63)
  (at package-84 city-loc-24)
  (at package-85 city-loc-18)
  (at package-86 city-loc-33)
  (at package-87 city-loc-9)
  (at package-88 city-loc-8)
  (at package-89 city-loc-32)
  (at package-90 city-loc-52)
  (at package-91 city-loc-24)
  (at package-92 city-loc-0)
  (at package-93 city-loc-16)
  (at package-94 city-loc-56)
  (at package-95 city-loc-50)
  (at package-96 city-loc-54)
  (at package-97 city-loc-69)
  (at package-98 city-loc-43)
  (at package-99 city-loc-28)
  (at truck-0 city-loc-51)
  (at truck-1 city-loc-19)
  (at truck-2 city-loc-43)
  (at truck-3 city-loc-26)
  (at truck-4 city-loc-52)
  (at truck-5 city-loc-28)
  (at truck-6 city-loc-63)
  (at truck-7 city-loc-31)
 ...
 (:goal (and
  ...
  (at package-27 city-loc-62)
  (at package-28 city-loc-42)
  (at package-29 city-loc-10)
  (at package-30 city-loc-38)
  (at package-31 city-loc-50)
  (at package-32 city-loc-30)
  (at package-33 city-loc-33)
  (at package-34 city-loc-6)
  (at package-35 city-loc-55)
  (at package-36 city-loc-13)
  (at package-37 city-loc-1)
  (at package-38 city-loc-18)
  (at package-39 city-loc-16)
  (at package-40 city-loc-45)
  (at package-41 city-loc-34)
  (at package-42 city-loc-42)
  (at package-43 city-loc-25)
  (at package-44 city-loc-29)
  (at package-45 city-loc-26)
  (at package-46 city-loc-23)
  (at package-47 city-loc-6)
  (at package-48 city-loc-22)
  (at package-49 city-loc-63)
  (at package-50 city-loc-47)
  (at package-51 city-loc-1)
  (at package-52 city-loc-24)
  (at package-53 city-loc-12)
  (at package-54 city-loc-11)
  (at package-55 city-loc-65)
  (at package-56 city-loc-42)
  (at package-57 city-loc-33)
  (at package-58 city-loc-61)
  (at package-59 city-loc-48)
  (at package-60 city-loc-66)
  (at package-61 city-loc-62)
  (at package-62 city-loc-59)
  (at package-63 city-loc-30)
  (at package-64 city-loc-40)
  (at package-65 city-loc-34)
  (at package-66 city-loc-10)
  (at package-67 city-loc-21)
  (at package-68 city-loc-8)
  (at package-69 city-loc-15)
  (at package-70 city-loc-44)
  (at package-71 city-loc-8)
  (at package-72 city-loc-27)
  (at package-73 city-loc-11)
  (at package-74 city-loc-12)
  (at package-75 city-loc-35)
  (at package-76 city-loc-14)
  (at package-77 city-loc-37)
  (at package-78 city-loc-36)
  (at package-79 city-loc-69)
  (at package-80 city-loc-24)
  (at package-81 city-loc-12)
  (at package-82 city-loc-13)
  (at package-83 city-loc-27)
  (at package-84 city-loc-64)
  (at package-85 city-loc-8)
  (at package-86 city-loc-56)
  (at package-87 city-loc-15)
  (at package-88 city-loc-55)
  (at package-89 city-loc-17)
  (at package-90 city-loc-63)
  (at package-91 city-loc-34)
  (at package-92 city-loc-27)
  (at package-93 city-loc-42)
  (at package-94 city-loc-69)
  (at package-95 city-loc-16)
  (at package-96 city-loc-47)
  (at package-97 city-loc-57)
  (at package-98 city-loc-49)
  (at package-99 city-loc-1)
 ))
)
