(define (problem pfile10)
 (:domain transport)
 (:objects
  city-loc-0 city-loc-1 city-loc-2 city-loc-3 city-loc-4 city-loc-5 city-loc-6 - location
  truck-0 - vehicle
  package-0 package-1 package-2 package-3 package-4 package-5 package-6 package-7 - package
