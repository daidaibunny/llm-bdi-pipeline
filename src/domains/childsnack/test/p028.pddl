; child-snack task with 33 children and 0.4 gluten factor 
; constant factor of 1.3
; random seed: 4028

(define (problem childsnack-p028)
  (:domain child-snack)
  (:objects
