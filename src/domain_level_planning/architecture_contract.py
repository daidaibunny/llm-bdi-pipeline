		...
		gaps=(
			...
			ArchitectureGap(
				...
				current_state=(
					...
					"ordering also supports one-hop positive precondition bindings "
					"for hidden producer goal arguments when the producer and consumer "
					"goal predicates differ, and composer evidence reports those "
					"binding contexts separately from direct causal orderings. Composer evidence "
			...
			ArchitectureGap(
				...
				current_state=(
					...
					"per-missing-rule-binding diagnostics, and strict paper-profile "
					"failures include compact feature:operator binding reasons; "
					"paper policy audit readiness requires every parsed learned rule "
					"to have bound conditions, bound effects, and a non-empty executable "
					"body; external learned sketch candidates "
