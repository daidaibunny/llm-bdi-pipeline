...
class Config:
	...
	@property
	def input_pipeline_max_semantic_retries(self) -> int:
		return max(int(os.getenv("INPUT_PIPELINE_MAX_SEMANTIC_RETRIES", "3")), 0)

	@property
	def input_pipeline_results_root(self) -> str:
		return os.getenv("INPUT_PIPELINE_RESULTS_ROOT", "results")
